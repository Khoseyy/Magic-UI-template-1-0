...
export const siteConfig = {
  ...
  hero: {
    ...
    badge: "Unparalleled",
    title: "Strategy, Copywriting & Google Ads",
    description:
      "Helping DTC brands increase their bottom line with sharper marketing strategy, conversion-focused copy, and high-intent Google Ads.",
    cta: {
      primary: {
