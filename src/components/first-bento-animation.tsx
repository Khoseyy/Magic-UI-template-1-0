...
export function ReasoningBasic() {
  const reasoningText = `Got it. Let’s figure out if this is a traffic problem or a conversion one.
If no one’s seeing your stuff, we’ll fix that. If they are but not buying either — then it’s likely time to rebuild the funnel and tighten your entire strategy.`;
    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          ...
          >
            <p className="text-sm">
              We’ve tried everything. Socials, ads, emails. But nothing’s converting the way it should. Not sure what’s wrong, we just know we’re stuck.
            </p>
          </motion.div>
